#' AI values computed from bunch of replicates
#'
#' Calculates allelic imbalances from merged data over given replicates.
#'
...
#'
#' @return A table with IDs and calculated AI estimates for given set of replicates
#'
